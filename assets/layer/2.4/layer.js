...
!(function (a, b) {
  ...
  var c,
    ...
    f = {
      ...
      alert: function (a, b, d) {
        ...
        return (
          e && (d = b), f.open(c.extend({ content: a, yes: d }, e ? {} : b))
        );
      },
      confirm: function (a, b, d, g) {
        ...
        return (
          h && ((g = d), (d = b)),
          f.open(
            c.extend({ content: a, btn: e.btn, yes: d, btn2: g }, h ? {} : b)
          )
        );
      },
      msg: function (a, d, g) {
  ...
  (h.anim = [
    ...
    (g.pt.auto = function (a) {
      ...
      "" === f.area[0] &&
        f.maxWidth > 0 &&
        (/MSIE 7/.test(navigator.userAgent) && f.btn && g.width(g.innerWidth()),
      ...
      b.tips[1] || j.remove(),
        (i.autoLeft = function () {
          i.left + f[0] - d.width() > 0
            ? ((i.tipLeft = i.left + i.width - f[0]),
              j.css({ right: 12, left: "auto" }))
            : (i.tipLeft = i.left);
        }),
        (i.where = [
          function () {
            i.autoLeft(),
              ...
              j
                ...
                .css("border-right-color", b.tips[1]);
          },
          function () {
        ...
        1 === k
          ...
          : 3 === k
          ? i.top - d.scrollTop() + i.height + f[1] + 16 - d.height() > 0 &&
            i.where[0]()
    ...
    (g.pt.callback = function () {
      ...
      b.openLayer(),
        g.success &&
          (2 == g.type
            ? d.find("iframe").on("load", function () {
                g.success(d, b.index);
              })
            : g.success(d, b.index)),
        f.ie6 && b.IE6(d),
    ...
    (g.pt.openLayer = function () {
      ...
      (f.zIndex = a.config.zIndex),
        (f.setTop = function (a) {
          ...
          return (
            (f.zIndex = parseInt(a[0].style.zIndex)),
            a.on("mousedown", b),
            f.zIndex
          );
        });
    ...
    (e.rescollbar = function (a) {
      h.html.attr("layer-full") == a &&
        (h.html[0].style.removeProperty
          ...
          : h.html[0].style.removeAttribute("overflow"),
        h.html.removeAttr("layer-full"));
    }),
    (a.layer = f),
    (f.getChildFrame = function (a, b) {
      return (
        (b = b || c("." + h[4]).attr("times")),
        c("#" + h[0] + b)
          .find("iframe")
          .contents()
          .find(a)
    ...
    (f.style = function (a, b) {
      ...
      (f === e.type[1] || f === e.type[2]) &&
        (d.css(b),
        f === e.type[2] &&
          d.find("iframe").css({ height: parseFloat(b.height) - g - i }));
    }),
    (f.min = function (a, b) {
      var d = c("#" + h[0] + a),
        g = d.find(h[1]).outerHeight() || 0;
          ...
          if (
            (d ||
              n.on("click", b.img, function () {
                ...
                f.photos(
                  c.extend(b, {
                    photos: { start: d, data: l, tab: b.tab },
                    full: b.full
                  }),
                  !0
                ),
