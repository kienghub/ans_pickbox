            ...
            value: function (t, e, i, a, s, r, n, o) {
              ...
              s || (s = t.attr("pathFrom")),
                ...
                (!s || s.indexOf("undefined") > -1 || s.indexOf("NaN") > -1) &&
                  ((s = "M 0 ".concat(h.globals.gridHeight)), (n = 1)),
                (r.indexOf("undefined") > -1 || r.indexOf("NaN") > -1) &&
                  ((r = "M 0 ".concat(h.globals.gridHeight)), (n = 1)),
              ...
              value: function (t) {
                ...
                return (
                  !L || A.globals.resized || A.globals.dataChanged
                    ...
                    : C.animatePathsGradually(n({}, X, { speed: g, delay: d })),
                  A.globals.dataChanged &&
                    P &&
                    z &&
                    C.animatePathsGradually(n({}, X, { speed: p })),
                  M
                );
              },
            },
                ...
                tooltip: {
                  ...
                  custom: function (t) {
                    ...
                    if (void 0 === n.config.tooltip.x.formatter)
                      ...
                      (c = n.config.tooltip.x.formatter(o)),
                        (d = n.config.tooltip.x.formatter(l));
                    return (
                      '<div class="apexcharts-tooltip-rangebar"><div> <span class="series-name" style="color: ' +
                      g +
                      '">' +
                      (n.config.series[i].name ? n.config.series[i].name : "") +
        ...
        a(t, [
          {
            ...
            value: function (t) {
              ...
              h.appendChild(c),
                c.setAttributeNS("http://www.w3.org/1999/xlink", "href", n),
                p.setAttrs(c, {
                  x: 0,
                  y: 0,
              ...
              if (
                ...
                for (var h = 0; h < n.x.length; h++) {
                  ...
                  if (
                    ...
                    g.isNumber(n.y[h])
                      ? (d += " w".concat(g.randomId()))
                      : (d = "apexcharts-nullpoint");
                    var f = this.getMarkerConfig(d, e, c);
                    s.config.series[r].data[i] &&
                      (s.config.series[r].data[i].fillColor &&
                        (f.pointFillColor =
                          s.config.series[r].data[i].fillColor),
                      s.config.series[r].data[i].strokeColor &&
                        (f.pointStrokeColor =
                          s.config.series[r].data[i].strokeColor)),
                      (a = l.drawMarker(n.x[h], n.y[h], f)).attr("rel", c),
                      a.attr("j", c),
                      a.attr("index", e),
                      a.node.setAttribute("default-marker-size", f.pSize),
                      new u(this.ctx).setSelectionFilter(a, e, c),
                      this.addEvents(a),
                      o && o.add(a);
                  } else
                    void 0 === s.globals.pointsArray[e] &&
                      (s.globals.pointsArray[e] = []),
                      s.globals.pointsArray[e].push([n.x[h], n.y[h]]);
                }
              return o;
            },
          },
                ...
                if (
                  ...
                  if ("bubble" === r.config.chart.type) {
                    (f = x((u = r.globals.seriesZ[e][c]))),
                      (h = t.y[g] + r.config.dataLabels.offsetY);
          ...
          },
          {
            ...
            value: function (t, e) {
              ...
              if ("mousemove" === t.type) {
                ...
                null !== r &&
                  (i.globals.axisCharts ||
                    r.parentNode.classList.remove("legend-mouseover-inactive"),
                  r.classList.remove("legend-mouseover-inactive"));
          ...
          },
          {
            ...
            value: function () {
              ...
              ("bar" === r ||
                ...
                new E(this).getLargestMarkerSize();
              ...
              if (
                ...
                for (
                  ...
                  i.config.grid.xaxis.lines.show &&
                    ...
                    new N(this.ctx).drawXaxisTicks(s, this.elg),
                ...
                if (t.series.length)
                  for (
                    ...
                    for (var h = 0, c = 0, d = 0; d < t.series.length; d++)
                      null !== t.series[d][l] &&
                        g.isNumber(t.series[d][l]) &&
                        (t.series[d][l] > 0
                          ? (h = h + parseFloat(t.series[d][l]) + 1e-4)
                          : (c += parseFloat(t.series[d][l]))),
                        d === t.series.length - 1 && (n.push(h), o.push(c));
                for (var u = 0; u < n.length; u++)
                  (t.maxY = Math.max(t.maxY, n[u])),
                    (t.minY = Math.min(t.minY, o[u]));
              }
              if (
                ("line" === e.chart.type ||
                  "area" === e.chart.type ||
          ...
          },
          {
            ...
            value: function () {
              ...
              if (t.isXNumeric)
                for (var a = 0; a < t.series.length; a++)
                  if (t.labels[a])
                    for (var s = 0; s < t.labels[a].length; s++)
                      null !== t.labels[a][s] &&
                        g.isNumber(t.labels[a][s]) &&
                        ((t.maxX = Math.max(t.maxX, t.labels[a][s])),
                        (t.initialMaxX = Math.max(t.maxX, t.labels[a][s])),
                        (t.minX = Math.min(t.minX, t.labels[a][s])),
                        (t.initialMinX = Math.min(t.minX, t.labels[a][s])));
              if (
                (t.noLabelsProvided &&
                ...
                if (
                  (void 0 === e.xaxis.tickAmount
                    ...
                    ? (t.series.length > 1 &&
                        (r = t.series[t.maxValsInArrayIndex].length - 1),
                      t.isXNumeric && (r = t.maxX - t.minX - 1))
                    : (r = e.xaxis.tickAmount),
                  (t.xTickAmount = r),
                  void 0 !== e.xaxis.max &&
                    "number" == typeof e.xaxis.max &&
                    (t.maxX = e.xaxis.max),
                  ...
                  (t.xAxisScale = this.scales.linearScale(1, r, r)),
                    t.noLabelsProvided &&
                      t.labels.length > 0 &&
              ...
              if (t.minX === t.maxX) {
                ...
                if ("datetime" === e.xaxis.type) {
                  var h = e.xaxis.labels.datetimeUTC,
                    c = l.getDate(t.minX);
                  h
                    ? c.setUTCDate(c.getDate() - 2)
                    : c.setDate(c.getDate() - 2),
                    (t.minX = new Date(c).getTime());
                  var d = l.getDate(t.maxX);
                  h
                    ? d.setUTCDate(d.getDate() + 2)
                    : d.setDate(d.getDate() + 2),
                    (t.maxX = new Date(d).getTime());
                } else
                  ("numeric" === e.xaxis.type ||
                    ("category" === e.xaxis.type && !t.noLabelsProvided)) &&
                    ((t.minX = t.minX - 2),
        ...
        a(t, [
          {
            ...
            value: function (t) {
              ...
              if (void 0 !== e.config.yaxis[t].title.text) {
                var y = i.group({ class: "apexcharts-yaxis-title" }),
                  w = 0;
                e.config.yaxis[t].opposite &&
                  (w = e.globals.translateYAxisX[t]);
                var k = i.drawText({
                  x: w,
                  y:
              ...
              var A = e.config.yaxis[t].axisBorder,
                S = 31 + A.offsetX;
              if (
                (e.config.yaxis[t].opposite && (S = -31 - A.offsetX), A.show)
              ) {
                var C = i.drawLine(
                  S,
                  e.globals.translateY + A.offsetY - 2,
                  S,
                  e.globals.gridHeight + e.globals.translateY + A.offsetY + 2,
                  A.color,
                  0,
                  A.width
                );
                  ...
                  n = function () {
                    ...
                    if (n > a) {
                      ...
                      for (var l = 0; l < s.length; l++)
                        n < s[l].breakpoint &&
                          ((t = E.extendArrayProps(r, s[l].options)),
                          (t = g.extend(i.config, t)),
                          e.overrideResponsiveOptions(t));
                  };
                if (t) {
              ...
              if (
                ...
                for (
                  var s = t.config.theme.monochrome.color,
                    r = 1 / (a / t.config.theme.monochrome.shadeIntensity),
                    n = t.config.theme.monochrome.shadeTo,
                    o = 0,
                    l = 0;
                  l < a;
                  l++
                  ...
                  var h = void 0;
                  "dark" === n
                    ? ((h = e.shadeColor(-1 * o, s)), (o += r))
                    : ((h = e.shadeColor(o, s)), (o += r)),
                    i.push(h);
                }
            ...
            value: function () {
              ...
              if (
                ...
                var h = new D(this.dCtx.ctx),
                  c = r;
                (r = h.xLabelFormat(s, r, c)),
                  (n = h.xLabelFormat(s, n, c)),
                  e.config.xaxis.convertedCatToNumeric &&
                    void 0 === r &&
                    (n = r = "1");
                ...
                if (
                  ...
                  if (!e.globals.isBarHorizontal) {
                    ...
                    (f = b(r)),
                      r !== n && (x = b(n)),
                      (t.height =
                        (f.height > x.height ? f.height : x.height) / 1.5),
                      (t.width = f.width > x.width ? f.width : x.width);
                  }
                ...
                e.config.yaxis.map(function (s, r) {
                  if (
                    ...
                    if (
                      ...
                      if (
                        ((l = o =
                          n((o = g.getLargestStringFromArr(h)), {
                            seriesIndex: r,
                            dataPointIndex: -1,
                            w: e,
                          })),
                    ...
                    var f = new p(t.dCtx.ctx),
                      ...
                      b = x;
                    o !== l && (b = f.getTextRects(l, s.labels.style.fontSize)),
                      i.push({
          ...
          },
          {
            ...
            value: function () {
              ...
              if (!i.legend.show || i.legend.floating)
                return (
                  (e.gridHeight = e.svgHeight - e.goldenPadding),
        ...
        a(t, [
          ...
          },
          {
            ...
            value: function (t, e, i) {
              ...
              if (e.total.show && s.globals.series.length > 1)
                ...
                if (
                  (Array.prototype.forEach.call(n, function (t) {
                    "true" === t.getAttribute("data:pieClicked") &&
                      ((o = !0), a.printDataLabelsInner(t, e));
                  }),
                  !o)
                )
                  if (
                    ...
                    if (s.globals.selectedDataPoints[0].length > 0) {
                      var l = s.globals.selectedDataPoints[0],
                        h = s.globals.dom.baseEl.querySelector(
                          ".apexcharts-"
                            .concat(
                              s.config.chart.type.toLowerCase(),
                              "-slice-"
                            )
                            .concat(l)
                        );
              ...
              if ("heatmap" === e.config.chart.type || this.isBarsDistributed) {
                if (i) {
                  ...
                  this.ctx.events.fireEvent("legendHover", [
                    ...
                    new R(this.ctx).highlightRangeInSeries(t, t.target);
                }
              } else
                !t.target.classList.contains("apexcharts-inactive-legend") &&
                  i &&
                  new R(this.ctx).toggleSeriesOnHover(t, t.target);
            },
          },
          {
            key: "onLegendClick",
        ...
        a(t, [
          {
            ...
            value: function () {
              ...
              for (var r = 0; r < a.length; r++)
                p.setAttrs(a[r].el, { class: a[r].class, title: a[r].title }),
                  (a[r].el.innerHTML = a[r].icon),
                  e.appendChild(a[r].el);
              ...
              for (
                ...
                this.elMenuItems.push(document.createElement("div")),
                  (this.elMenuItems[o].innerHTML = n[o].title),
                ...
                this.elMenuItems.forEach(function (e) {
                  e.classList.contains("exportSVG")
                    ...
                    : e.classList.contains("exportCSV") &&
                      e.addEventListener("click", t.downloadCSV.bind(t));
                });
            ...
            value: function () {
              this.toggleOtherControls(),
                (this.w.globals.selectionEnabled =
                  !this.w.globals.selectionEnabled),
                this.elSelection.classList.contains("apexcharts-selected")
          ...
          },
          {
            ...
            value: function () {
              this.toggleOtherControls(),
                ...
                this.elZoom.classList.contains("apexcharts-selected")
          ...
          },
          {
            ...
            value: function () {
              this.toggleOtherControls(),
                ...
                this.elZoom && this.elZoom.classList.add("apexcharts-selected"),
                this.elPan &&
          ...
          },
          {
            ...
            value: function () {
              this.toggleOtherControls(),
                ...
                this.elPan && this.elPan.classList.add("apexcharts-selected"),
                this.elZoom &&
                  this.elZoom.classList.remove("apexcharts-selected");
            },
          },
          {
            ...
            value: function () {
              this.toggleOtherControls(),
                ...
                this.elPan.classList.contains("apexcharts-selected")
                  ? this.elPan.classList.remove("apexcharts-selected")
                  : this.elPan.classList.add("apexcharts-selected");
            },
          },
              ...
              if (
                ...
                if (
                  ...
                  a.w.globals.mousedown &&
                    ...
                    i.globals.panEnabled && a.delayedPanScrolled(),
        ...
        a(t, [
          {
            ...
            value: function (t) {
              ...
              ((r && n.globals.comboCharts) || r) &&
                (l = o / n.globals.dataPoints);
              var c = a - h.left,
                d = s - h.top;
              c < 0 ||
              d < 0 ||
              c > n.globals.gridWidth ||
              ...
              for (
                ...
                m < n.globals.seriesXvalues.length;
                m++
              )
                b.push(
                  [n.globals.seriesXvalues[m][0] - 1e-6].concat(
                    n.globals.seriesXvalues[m]
                  )
                );
              return (
                (b = b.map(function (t) {
        ...
        a(t, [
          {
            ...
            value: function (t) {
              ...
              void 0 !== this.w.config.tooltip.custom
                ? this.handleCustomTooltip({ i: r, j: o, y1: l, y2: h })
          ...
          },
          {
            ...
            value: function (t) {
              ...
              if (
                ...
                (r.globals.isBarHorizontal && n.hasBars()) ||
        ...
        a(t, [
            ...
            value: function () {
              ...
              if (
                ...
                for (var c = 0; c < n.length; c++)
                  o.push(n[c].getAttribute("cy")),
                    l.push(n[c].getAttribute("cx"));
              if (
            ...
            value: function () {
              ...
              return (
                this.tConfig.fixed.position.toLowerCase().indexOf("right") >
                  -1 && (r = r + t.globals.svgWidth - a + 10),
                this.tConfig.fixed.position.toLowerCase().indexOf("bottom") >
                  -1 && (n = n + t.globals.svgHeight - s - 10),
                (e.style.left = r + "px"),
                (e.style.top = n + "px"),
          ...
          },
          {
            ...
            value: function (t) {
              ...
              (i.e = s),
              !i.hasBars() || r.globals.comboCharts || i.isBarShared) ||
                (this.tConfig.onDatasetHover.highlightDataSeries &&
                  new R(e).toggleSeriesOnHover(s, s.target.parentNode));
                ...
                var g = this.getElTooltip(),
                  ...
                  f =
                    ...
                    ("bar" === n.config.chart.type &&
                      ...
                      this.hasBars() &&
                      this.tConfig.shared) ||
                    (n.globals.comboCharts && this.hasBars);
                if (
                  (n.globals.isBarHorizontal && this.hasBars() && (f = !1),
                  "mousemove" === s.type ||
                    "touchmove" === s.type ||
                    "mouseup" === s.type)
                ) {
                  if (
                    ...
                    if (null !== p) {
                      if (null === n.globals.series[p][e])
                        return void this.handleMouseOut(r);
                      void 0 !== n.globals.series[p][e]
                        ? this.tConfig.shared &&
                          this.tooltipUtil.isXoverlap(e) &&
                          this.tooltipUtil.isInitialSeriesSameLen()
                          ? this.create(s, this, p, e, r.ttItems)
                          : this.create(s, this, p, e, r.ttItems, !1)
                        : this.tooltipUtil.isXoverlap(e) &&
                          this.create(s, this, 0, e, r.ttItems);
                    } else
                      this.tooltipUtil.isXoverlap(e) &&
                        this.create(s, this, 0, e, r.ttItems);
                    ...
                    this.hasBars &&
                      this.intersect.handleBarTooltip({ e: s, opt: r }),
                      this.hasMarkers &&
          ...
          },
          {
            ...
            value: function (t) {
              ...
              switch ((this.barCtx.isReversed && (i += o), d.position)) {
                ...
                case "bottom":
                  h = x
                    ? i - o - c - Math.round(l.width / 2) - g
                    : i - o + c + Math.round(l.width / 2) + g;
                  break;
                case "top":
                  h = x
                    ? i - c + Math.round(l.width / 2) - g
                    : i - c - Math.round(l.width / 2) + g;
              }
              return (
        ...
        a(t, [
          {
            ...
            value: function (t, e) {
              ...
              for (var o = 0, l = 0; o < t.length; o++, l++) {
                ...
                for (
                  var S = a.group({ class: "apexcharts-datalabels" }), C = 0;
                  ...
                  this.isHorizontal
                    ? ((P = this.drawBarPaths(
                        n({}, z, { barHeight: w, zeroW: u, yDivision: c })
                      )),
                      (k = this.series[o][C] / this.invertedYRatio))
                    : ((P = this.drawColumnPaths(
                        n({}, z, { xDivision: h, barWidth: k, zeroH: d })
                      )),
            ...
            value: function (t, e) {
              ...
              for (
                ...
                var y = this.graphics.group({
                  ...
                  w = this.graphics.group({ class: "apexcharts-datalabels" }),
                  k = 0,
                  A = 0,
                ...
                for (var C = 0; C < i.globals.dataPoints; C++) {
                  var L = this.barHelpers.getStrokeWidth(h, C, v),
                    P = {
                      indexes: { i: h, j: C, realIndex: v, bc: c },
                      strokeWidth: L,
                      x: o,
                      y: l,
                      elSeries: y,
                  ...
                  this.isHorizontal
                    ? ((z = this.drawBarPaths(
                        n({}, P, { zeroW: x, barHeight: k, yDivision: u })
                      )),
                      (A = this.series[h][C] / this.invertedYRatio))
                    : ((z = this.drawColumnPaths(
                        n({}, P, { xDivision: d, barWidth: A, zeroH: f })
                      )),
                      (k = this.series[h][C] / this.yRatio[this.yaxisIndex])),
                    (l = z.y),
                    (o = z.x),
                    b.push(o),
                    m.push(l);
                ...
                (i.globals.seriesXvalues[v] = b),
                  (i.globals.seriesYvalues[v] = m),
          ...
          },
          {
            ...
            value: function (t) {
              ...
              if (
                ...
                p =
                  this.prevYVal[c - 1][d] < 0
                    ? this.series[c][d] >= 0
                      ? v - b + 2 * (this.isReversed ? b : 0)
                      : v
                    : this.series[c][d] >= 0
                    ? v
                    : v + b - 2 * (this.isReversed ? b : 0);
              ...
              this.yArrj.push(w.newY),
                this.yArrjF.push(Math.abs(p - w.newY)),
                this.yArrjVal.push(this.series[c][d]);
              var k = this.graphics.move(x, p),
                A = this.graphics.move(x, p);
              if (
                (h.globals.previousPaths.length > 0 &&
                  (A = this.bar.getPreviousPath(g, d, !1)),
                (k =
                  k +
                  this.graphics.line(x, w.newY) +
                  w.path +
            ...
            value: function (t, e) {
              ...
              for (
                ...
                (d = y.y),
                  ...
                  f.push(c + v / 2);
                for (
                  var w = a.group({ class: "apexcharts-datalabels" }), k = 0;
              ...
              if (
                ...
                t.forEach(function (t, o) {
                  ...
                  (d = e.graphics.group({
                    ...
                    (f = e.graphics.group({ class: "apexcharts-datalabels" })),
                  ...
                  t.forEach(function (t, a) {
                    var s = new I(e.ctx).getMarkerConfig(
                        "apexcharts-marker",
                        o,
                        a
                      ),
                    ...
                    h.attr("rel", a),
                      h.attr("j", a),
                      h.attr("index", o),
                      h.node.setAttribute("default-marker-size", s.pSize);
            ...
            value: function (t) {
              ...
              for (
                ...
                !this.initialAnim ||
                  e.globals.resized ||
                  e.globals.dataChanged ||
                  ((E = ((S - w) / 360) * e.config.chart.animations.speed),
                  (this.animDur = E / (1.2 * t.series.length) + this.animDur),
                  this.animBeginArr.push(this.animDur)),
                  e.globals.dataChanged &&
                    ((E =
                      ((S - w) / 360) *
            ...
            value: function (t, e) {
              ...
              for (
                ...
                (d = v.y),
                  ...
                  (l = v.zeroH);
                for (
                  var y = a.group({ class: "apexcharts-datalabels" }), w = 0;
        ...
        a(t, [
          {
            ...
            value: function (t, e) {
              ...
              if (
                ...
                new E(this.lineCtx.ctx, i).seriesHaveSameValues(t)
              ) {
                var a = e[t].slice();
              ...
              for (
                ...
                if (b.globals.isXNumeric) {
                  ...
                  void 0 === b.globals.seriesX[i][P + 1] &&
                    (T = b.globals.seriesX[i][L - 1]),
                    (s = (T - b.globals.minX) / this.xRatio);
        ...
        a(t, [
          ...
          },
          {
            ...
            value: function () {
              ...
              ("top" !== t.config.legend.position &&
                "bottom" !== t.config.legend.position) ||
                (i = new rt(this.ctx).legendHelpers.getLegendBBox().clwh + 10);
              var a = t.globals.dom.baseEl.querySelector(
          ...
          },
          {
            ...
            value: function () {
              ...
              if (e.globals.axisCharts) {
                ...
                if (
                  ((t = new E(this.ctx).getCalculatedRatios()),
                ...
                n.forEach(function (s) {
                  ...
                  return (
                    ...
                    e &&
                      "object" === t(e) &&
                      ((s.config = new P(e)),
                      (e = E.extendArrayProps(s.config, e)),
                      (n.config = g.extend(n.config, e)),
                      r &&
                        ((n.globals.lastXAxis = []),
                        (n.globals.lastYAxis = []),
                        (n.globals.initialConfig = g.extend({}, n.config)),
                        (n.globals.initialSeries = JSON.parse(
                          JSON.stringify(n.config.series)
                        )))),
                    s.update(e)
                  );
                });
          ...
          case "A":
            t = (e = (function (t, e) {
              var i,
                ...
                F = new SVG.Point(X, Y),
                D = [];
              if (0 === z || 0 === T || (R.x === F.x && R.y === F.y))
                return [["C", R.x, R.y, F.x, F.y, F.x, F.y]];
              (i = new SVG.Point((R.x - F.x) / 2, (R.y - F.y) / 2).transform(
              ...
              (h = new SVG.Point(
                ...
                (c = new SVG.Point(R.x - h.x, R.y - h.y)),
        ...
        a(t, [
          {
            ...
            value: function () {
              (this.ctx.publicMethods = [
                ...
                (this.ctx.coreUtils = new E(this.ctx)),
                ...
                (this.ctx.series = new R(this.ctx)),
                (this.ctx.theme = new $(this.ctx)),
                (this.ctx.formatters = new D(this.ctx)),
