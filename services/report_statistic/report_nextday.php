     ...
     <div class="page-wrapper">
          ...
          <div class="page-content">
               ...
               <div class="page-header">
                    <ol class="breadcrumb">
                         ...
                         <li class="breadcrumb-item active">ລາຍງານພັດສະດຸທີ່ຮັບເຂົ້າສາງ</li>
                    </ol>
          ...
          if($_GET['start_date']=="" & $_GET['end_date']==""){
               ...
               $sum_qty_for_next_day=$_sql($main_db,"SELECT count(id_list) as qty FROM ans_item_next_day 
                                                  LEFT JOIN ans_items ON ans_items.id_item = ans_item_next_day.item_id WHERE ans_items.charge_on_shop=0 AND ans_items.status_id=3 $params");
               ...
               $sum_qty_for_next_day2=$_sql($main_db,"SELECT count(id_list) as qty FROM ans_item_next_day 
                                                  LEFT JOIN ans_items ON ans_items.id_item = ans_item_next_day.item_id WHERE ans_items.charge_on_shop=1 AND ans_items.status_id=3 $params");
...
// FUNCTION
     ...
     function _countFromBranch($x){
          include('../../connection.php');
          global $params;
          $query=mysqli_query($main_db,"SELECT count(id_item) as qty FROM ans_items WHERE status_id=3 AND original_branch_id='$x' $params");
          $res=$_assoc($query);
          echo @number_format($res['qty']);
          mysqli_close($main_db);
     }
          ...
          global $params;
          $query=mysqli_query($main_db,"SELECT sum(ans_item_next_day.packagePrice) as packagePrice FROM ans_item_next_day 
                                        LEFT JOIN ans_items ON ans_items.id_item = ans_item_next_day.item_id WHERE ans_items.status_id=3 AND ans_items.original_branch_id='$x' $params");
          $res=$_assoc($query);
          echo @number_format($res['packagePrice']);
          mysqli_close($main_db);
     }
...
?>
                    ...
                    <div class="row">
                         <div class="col-md-12">
                              <div class="blog p-4">
                                   <div class="col-md-12 p-4">
                                        <div class="date_search">
                                             <div class="row">
                                                  ...
                                                  <div class="col-md-2">
                                                       <label for=""></label>
                                                       <a href="./print_nextday.php<?php echo $print ?>" target="_blank"
                                   ...
                                   <hr>
                                   <h3 class="text-center"><u>ລາຍງານພັດສະດຸເຂົ້າສາງ</u></h3>
                                   <ul class="p-3">
                                        <li>
                                                                      ...
                                                                      <div class="accordion-body">
                                                                           <div class="top-agents-container" id="main">
                                                                                ...
                                                                                <div class="top-agent" id="sublist">
                                                                                     <div class="agent-details">
                                                                                          <h5>
                                                                                               <?php _renderBranchName($res['original_branch_id'])?>
                                                                                          ...
                                                                                          <div class="agent-score">
                                                                                               <div class="progress">
                                                                                                    <div class="progress-bar bg-success"
                                                                                                         role="progressbar"
                                                                                                         style="width:<?php _percentFromBranch($res['original_branch_id']) ?>%"
                                                                                                         aria-valuenow="100"
                                                                                                         aria-valuemin="0"
                                                                                                         aria-valuemax="100">
                                                                                                    </div>
                                                                                               ...
                                                                                               <div class="points">
                                                                                                    <div class="left">
                                                                                                         ຈຳນວນເຄື່ອງເຂົ້າສາງທັງໝົດ
                                                                                                         <?php _countFromBranch($res['original_branch_id'])?>
                                                                                                         ອັນ
                                                                                                    </div>
                                                                                                    <div class="left">
                                                                                                         ມູນຄ່າ
                                                                                                         <?php _priceFromBranch($res['original_branch_id'])?>
                                                                                                         ກີບ
                                                                                                    </div>
                                                                                               </div>
                                                                                          </div>
                                                                 ...
                                                                 <div id="<?php echo $pro['provinceCode']?>"
                                                                      ...
                                                                      <div class="accordion-body">
                                                                           <div class="top-agents-container" id="main">
                                                                                ...
                                                                                <div class="top-agent" id="sublist">
                                                                                     <div class="agent-details">
                                                                                          <h5><?php _renderBranchName($res['original_branch_id'])?>
                                                                                          </h5>
                                                                                          <div class="agent-score">
                                                                                               <div class="progress">
                                                                                                    <div class="progress-bar bg-success"
          ...
          var options = {
               ...
               series: [
                    ...
                    <?php echo $sumRecWeight['weight']?>,
                    <?php echo $countRecQty['qty']?>,
                    <?php echo $countRecQty2['qty']?>
               ],
               responsive: [{
                    breakpoint: 480,
                    options: {
