          ...
          <div class="page-content">
               ...
               <div class="page-header">
                    <ol class="breadcrumb">
                         ...
                         <li class="breadcrumb-item active">ລາຍງານພັດສະດຸທີ່ສົ່ງສຳເລັດ</li>
                    </ol>
                              ...
                              <div class="blog p-4">
                                   <div class="col-md-12 p-4">
                                        <div class="date_search">
                                             <div class="row">
                                                  ...
                                                  <div class="col-md-2">
                                                       <label for=""></label>
                                                       <a href="./print_sameday.php?php echo $print ?>" target="_blank"
                                   ...
                                   <div class="row gutters">
                                        <div class="col-7 p-4">
                                             <ul>
                                                  <li class="p-2">
                                                       ເຄື່ອງສົ່ງສຳເລັດທັງໝົດ
                                                       <?php echo @number_format($sumRecQty['rec_qty'])?> ອັນ
                                                  </li>
                                                  <li class="p-2">
                                                       ມູນຄ່າເຄື່ອງສົ່ງສຳເລັດທັງໝົດ
                                   ...
                                   <hr>
                                   <h3 class="text-center"><u>ລາຍງານພັດສະດຸທີ່ສົ່ງສຳເລັດ</u></h3>
                                   <ul class="p-4">
                                        <li>
