...
<body class="bg-white" ng-app="app" ng-controller="addNew" ng-init="_callProducts();_callCategory()">
     <!-- Page wrapper start -->
                    ...
                    <div class="modal-body">
                         ...
                         <form action="#" method="post" id="AddCategory">
                              <div class="row">
                                   ...
                                   <div class="col-md-6">
                                        <button type="button" ng-click="_onSave()" class="btn btn-success btn-sm">
                                             <i class="icon-check-circle"></i> ບັນທຶກ
                                        </button>
                                        <button type="reset" class="btn btn-danger">
                                             <i class="icon-x-circle"></i> ຍົກເລີກ
