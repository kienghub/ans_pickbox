                              ...
                              <div class="table-container p-4">
                                   <div class="t-header mb-4">
                                        <ul class="nav nav-tabs">
                                             <li class="nav-item">
                                                  <a class="nav-link active" href="#">ລາຍການທີ່ຍັງບໍ່ທັນສົ່ງມອບ</a>
                                             </li>
                                             <li class="nav-item">
                                                  <a class="nav-link"
                                   ...
                                   <div class="row">
                                        ...
                                        <div class="col-md-2 pt-4">
                                             <button type="button"
                                                  <?php if($sale_qty['sale_qty']<1){echo "disabled";}else{echo "";}?>
                                                  ng-click="deliveredShow('ສົ່ງມອບການຂາຍ','./print.php?st_date=<?php echo $st_date ?>&end_date=<?php echo $end_date ?>',100,100)"
                                                  ...
                                                  <tbody>
                                                       ...
                                                       <?php
                                                            ...
                                                            $_Result=mysqli_query($con,"SELECT*FROM ans_sale
                                                                      ...
                                                                      WHERE s_status=1 AND ans_sale.s_date='$s_date' AND s_date BETWEEN '$st_date' AND '$end_date' AND ans_sale.branch_id='$_state_branch' group by ans_sale.pro_id ORDER BY ans_sale.s_date DESC");
