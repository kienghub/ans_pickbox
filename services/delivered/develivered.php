...
<?php 
     ...
     $callSummarySaleQty=$_sql($con,"SELECT sum(s_qty) AS sale_qty FROM ans_sale where s_status=0 AND branch_id='$_state_branch' AND s_date BETWEEN '$st_date' AND '$end_date'");
     $sale_qty=$_assoc($callSummarySaleQty);

     $callSummaryPrice=$_sql($con,"SELECT sum(s_qty*sprice) AS price FROM ans_sale where s_status=0 AND branch_id='$_state_branch' AND s_date BETWEEN '$st_date' AND '$end_date'");
...
<body ng-app="app" ng-controller="delivered" ng-init="
                              ...
                              <div class="table-container p-4">
                                   ...
                                   <div class="t-header mb-4">
                                        <ul class="nav nav-tabs">
                                             ...
                                             <li class="nav-item">
                                                  <a class="nav-link active" href="#">ລາຍການສົ່ງທີ່ສົ່ງມອບແລ້ວ</a>
                                             </li>
                                        </ul>
                                   </div>
                                   <div class="row">
                                        ...
                                        <table id="data" class="table table-striped table-hover table-sm">
                                             <thead>
                                                  ...
                                                  <tbody>
                                                       <?php
                                                       include('../../connection.php');
                                                       $sql=mysqli_query($con,"SELECT SUM(s_qty)as qtyTotal FROM ans_sale WHERE s_status=0 AND s_date BETWEEN '$st_date' AND '$end_date' AND branch_id='$_state_branch'");
                                                       $subTotal=$_assoc($sql);
                                                       $sumAllPrice=mysqli_query($con,"SELECT SUM(s_qty*sprice)AS priceTotal FROM ans_sale  WHERE s_status=0 AND s_date BETWEEN '$st_date' AND '$end_date' AND branch_id='$_state_branch'");
                                                       ...
                                                       function sumQty($x){
                                                            ...
                                                            global $st_date;
                                                            global $end_date;
                                                            $sql=mysqli_query($con,"SELECT SUM(s_qty)AS qtyTotal FROM ans_sale WHERE s_status=0 AND s_date BETWEEN '$st_date' AND '$end_date' AND s_date='$x' AND branch_id='$_state_branch'");
                                                            $res=$_assoc($sql);
                                                       ...
                                                       function sumPrice($x){
                                                            ...
                                                            global $st_date;
                                                            global $end_date;
                                                            $sql=mysqli_query($con,"SELECT SUM(s_qty*sprice)AS priceTotal FROM ans_sale WHERE s_status=0 AND s_date BETWEEN '$st_date' AND '$end_date' AND ans_sale.s_date='$x' AND branch_id='$_state_branch'");
                                                            $res=$_assoc($sql);
                                                       ...
                                                       $x=1;
                                                       $_branch=mysqli_query($con,"SELECT * FROM ans_sale WHERE s_status=0 AND s_date BETWEEN '$st_date' AND '$end_date'  AND branch_id='$_state_branch' GROUP BY s_date ORDER BY s_date DESC");
                                                       ...
                                                       <?php
                                                            ...
                                                            $_Result=mysqli_query($con,"SELECT*FROM ans_sale
                                                                      ...
                                                                      WHERE s_status=0 AND ans_sale.s_date='$s_date' AND s_date BETWEEN '$st_date' AND '$end_date' AND ans_sale.branch_id='$_state_branch' ORDER BY ans_sale.s_date DESC");
     ...
     function onSearch() {
          ...
          window.location = "develivered.php?st_date=" + st_date + "&end_date=" + end_date
     }
