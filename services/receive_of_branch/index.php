          ...
          <div class="page-content">
               ...
               <div class="page-header">
                    ...
                    <ul class="app-actions">
                         <li>
                              <button type="button" ng-click="_onAdd('ເພີ່ມເຄື່ອງເຂົ້າສາງ','./add_receive.php',900,550)"
                              ...
                              <div class="table-container p-4">
                                   ...
                                   <div class="row">
                                        <div class="col-md-3">
                                             ...
                                             <input type="date" class="form-control" ng-model='st_date' id="st_date"
                                                  value={{st_date}}>
                                        </div>
                                        <div class="col-md-3">
                                             <label for="">ເຖິງວັນທີ</label>
                                             <input type="date" class="form-control" ng-model="end_date" id="end_date"
                                                  value={{end_date}}>
                                        </div>
