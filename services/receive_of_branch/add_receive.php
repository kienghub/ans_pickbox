                         ...
                         <div class="col-6">
                              <div class="form-group">
                                   <label for="taskTitle">ຈຳນວນ
                                        <?php isVal()?></label>
                                   <input type="text" class="form-control text-right" id="rec_qty" name="rec_qty"
                                        required placeholder="00">
                              </div>
                         </div>
                         <div class="col-md-12">
                              <div class="form-group">
                                   <label for="taskTitle">ວັນທີ
                                        <?php isVal()?></label>
                                   <input type="date" class="form-control" name="rec_date" required value={{rec_date}}>
                              </div>
                         </div>
                         <div class="col-md-12">
                              <div class="form-group">
...
// INSERT DATA
    ...
    $_createReceive = $_sql($con, "INSERT INTO ans_receive_of_sale VALUE($data)");
    ...
    if ($_createReceive) { 
        $_sql($con, "INSERT INTO ans_pricing(pro_id,price_item,createdAt,createdBy)VALUE('$pro_id','$rec_sprice','$_timestamp','$userName')");
            if($catch<1){
                ...
                mysqli_query($con, "INSERT INTO ans_branch_stocks (pro_id,qty,branch_id)VALUE('$pro_id','$rec_qty','$_state_branch')");
