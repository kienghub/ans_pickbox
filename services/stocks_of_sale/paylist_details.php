...
<body ng-app="app" ng-controller="report_stock_of_sale" ng-init="
     ...
     <div class="main-container blog">
          <div class="row">
               <div class="col-md-2">
                    <div class="form-group">
                         ...
                         <select class="form-control select2" id="stateId" name="pro_id" onchange="selectedState()">
                              ...
                              <?php 
                                   include('../../connection.php');
                                   $query  =mysqli_query($con,"SELECT * FROM office_state_branches");
               ...
               <div class="col-md-2 pt-4">
                    <a href="./print_details.php?st_date=<?php echo $st_date ?>&end_date=<?php echo $end_date?>&state=<?php echo $state ?>"
                    ...
                    <table class="table table-striped table-hover table-sm">
                         <thead>
                              <tr style="background-color:#c92a2a;color:white">
                                   ...
                                   <th style="text-align:center">ວັນທີຂໍເບີກ</th>
          ...
          function onSearch() {
               ...
               var state = $('#state').val()
               window.location = "./paylist_details.php?st_date=" + st_date + "&end_date=" + end_date + "&state=" +
                    state
          }
          </script>
